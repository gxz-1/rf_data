...
#展示一张时频图
save_train_path = '/disk/datasets/rf_data/train_data/time_frequency/train/device_4'
save_test_path = '/disk/datasets/rf_data/train_data/time_frequency/val/snr_5/device_4'
filename='device_4_snr_5_sample_40.mat'
